...
COLLABORATIVE_FILTERING_MIN_INTERACTIONS = 3
COLLABORATIVE_FILTERING_WEIGHTS = {
    "watch": 1.0,
    "like": 3.0,
    "playlist": 4.0,
}
COLLABORATIVE_FILTERING_MAX_SIMILAR_ITEMS = 100
COLLABORATIVE_FILTERING_CACHE_TIMEOUT = 60 * 60 * 12
COLLABORATIVE_FILTERING_USER_CACHE_TIMEOUT = 15 * 60
...
CELERY_BEAT_SCHEDULE = {
    ...
    "build_collaborative_filtering_similarity": {
        "task": "build_collaborative_filtering_similarity",
