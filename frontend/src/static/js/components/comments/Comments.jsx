      ...
      <div className="comments-form-inner">
        ...
        <div className="form">
          ...
          <div className="form-buttons">
            <button
              className={'' === value.trim() || submitting ? 'disabled' : ''}
              disabled={'' === value.trim() || submitting}
              onClick={submitComment}
            >
              {submitting ? translateString('SUBMITTING...') : commentsText.submitCommentText}
            </button>
          </div>
        </div>
      </div>
    ...
    <div className="comments-form">
      <div className="comments-form-inner">
        ...
        <div className="form">
          ...
          <div className="form-buttons">
            <a href={loginUrl} rel="nofollow" className="disabled">
