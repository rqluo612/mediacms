  ...
  return (
    <div className="playlist-form-wrap">
      ...
      <div className="playlist-form-actions">
        <button className="cancel-btn" disabled={submitting} onClick={onCancelPlaylistCreation}>
          CANCEL
        </button>
        <button className="create-btn" disabled={submitting} onClick={onClickPlaylistCreate}>
