...
@task(name="build_collaborative_filtering_similarity", queue="long_tasks")
def build_collaborative_filtering_similarity():
    """Build and cache sparse item-to-item collaborative similarities."""
    from .services.recommendations import build_and_cache_item_similarities

    similarities = build_and_cache_item_similarities()
    logger.info("built collaborative-filtering cache for %s media", len(similarities))
