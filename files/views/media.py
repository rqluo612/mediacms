...
class MediaList(APIView):
    ...
    def get(self, request, format=None):
        ...
        if show_param == "recommended":
            ...
            media = get_recommended_media(request, limit=50)
            already_sorted = True
        ...
        if show_param == "recommended" and request.user.is_authenticated:
        ...
        try:
            ...
            if media.state == "private":
                ...
                has_access = user.is_authenticated and (
                    user.has_member_access_to_media(media) or is_mediacms_editor(user)
                )
                if not has_access:
                    return Response(
